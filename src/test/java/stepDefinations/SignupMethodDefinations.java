...
public class SignupMethodDefinations extends SetupClass{
	...
	public void Sign_up_to_monthly_on_Heathpro_plus() throws Throwable {
	    ...
	    log.info("it's entered value"+ mail);
