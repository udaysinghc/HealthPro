...
public class SignupStepDefinations extends SetupClass {
	...
	public void i_verify_the_popup(String popup) throws Throwable {
		...
		final String signup_title="Sign Up as a Client";
		...
		case signup_title:
			...
			webelement = driver.findElement(SignUpPage.signup_title);
			String titleText = webelement.getText();
			log.info(titleText);
			String expectedTitle = popup;
			assertEquals(expectedTitle, titleText);
			log.info("it's verify : "+popup);
			break;
	...
	public void click_on_Button(String button) throws Throwable {
		...
		final String signup_Client="Sign Up as a Client";
		...
		case signup_Client:
			webelement = driver.findElement(SignUpPage.signup_Client);
			ac.moveToElement(webelement).build().perform();
			webelement.click();
			Thread.sleep(2000);
			break;
